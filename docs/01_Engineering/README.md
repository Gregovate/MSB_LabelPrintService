...
- [Controller Label Request and Physical Format Contract — 2026-09-03](Controller_Label_Request_and_Physical_Format_Contract_2026-09-03.md) — deployed and accepted governed request/CTRL route, 24 mm/full-URL format, batch consumer, restart behavior, and offline-request recovery.
- [Brother SNMP Status Evidence](Brother_SNMP_Status_Evidence.md) — tracked raw PT-P950NW and QL-820NWB status packets plus the `4.1.0-rc3` observation-only active-job capture contract for the unresolved P950 low-tape racing-stripe signature.
