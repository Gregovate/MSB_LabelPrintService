/* ======================================================================
   Filename: container_labels_horizontal.csv
   Purpose:
     Export in-progress container labels for the HORIZONTAL container
     template.
   ...
   Rules:
     ...
     - container_type_id <> 1 uses horizontal template
     - quantity (2 labels per container) handled by print workflow

   Author: Greg Liebig / Engineering Innovations, LLC
   Date: 2026-03-19
   output file (Greg's PC) C:\MSB_LabelService\data\container_labels_horizontal.csv
   ====================================================================== */
